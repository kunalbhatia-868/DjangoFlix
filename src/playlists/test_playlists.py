...
class PlaylistModelTestCase(TestCase):
    def create_show_with_seasons(self):
        ...
        season_1 = Playlist.objects.create(title='The Office Series Season 1', parent=the_office, parent_order=1)
        season_2 = Playlist.objects.create(title='The Office Series Season 2', parent=the_office, parent_order=2)
        season_3 = Playlist.objects.create(title='The Office Series Season 3', parent=the_office, parent_order=3)
