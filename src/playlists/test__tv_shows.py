...
class TvShowProxyModelTestCase(TestCase):
    def create_show_with_seasons(self):
        ...
        season_1 = TvShowSeasonProxy.objects.create(title='The Office Series Season 1', state=PublishStateOptions.PUBLISH, parent=the_office, parent_order=1)
        season_2 = TvShowSeasonProxy.objects.create(title='The Office Series Season 2', parent=the_office, parent_order=2)
        season_3 = TvShowSeasonProxy.objects.create(title='The Office Series Season 3', parent=the_office, parent_order=3)
        season_4 = TvShowSeasonProxy.objects.create(title='The Office Series Season 4', parent=the_office, parent_order=4)
